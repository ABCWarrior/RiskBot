...
const ADJACENCY = {
  MISTHALIN:  ['ASGARNIA', 'MORYTANIA', 'KANDARIN', 'WILDERNESS'],
  ASGARNIA:   ['MISTHALIN', 'KANDARIN', 'TIRANNWN', 'WILDERNESS'],
  MORYTANIA:  ['MISTHALIN', 'WILDERNESS', 'ISLANDS'],
  KANDARIN:   ['MISTHALIN', 'ASGARNIA', 'TIRANNWN', 'FREMENNIK', 'WILDERNESS'],
  TIRANNWN:   ['ASGARNIA', 'KANDARIN', 'DESERT'],
  DESERT:     ['TIRANNWN', 'KANDARIN', 'MORYTANIA', 'KHARIDIAN'],
  KHARIDIAN:  ['DESERT', 'MORYTANIA'],
  FREMENNIK:  ['KANDARIN', 'WILDERNESS', 'ISLANDS'],
  WILDERNESS: ['MISTHALIN', 'ASGARNIA', 'MORYTANIA', 'KANDARIN', 'FREMENNIK'],
  ISLANDS:    ['MORYTANIA', 'FREMENNIK'],
  PANTHEON:   [],
};
